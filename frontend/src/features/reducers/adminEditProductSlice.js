...
const adminEditProductSlice=createSlice({
    ...
    reducers: {
        resetUpdateSuccess: (state) => {
          state.updatedproduct.success = false;
        },
        resetCreateSuccess: (state) => {
          state.createProduct.success = false;
        },
        resetProduct: (state) => {
          state.createProduct.product = {};
        },
      },
...
export const { resetUpdateSuccess,resetCreateSuccess,resetProduct } = adminEditProductSlice.actions;
